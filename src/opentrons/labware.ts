...
const boundedSection = z.object({
  geometry: z.discriminatedUnion("shape", [circularCrossSection, rectangularCrossSection]),
  topHeight: z.number(),
})
...
export const labware = z.object({
  ...
  innerLabwareGeometry: z.object({
    frusta: z.array(boundedSection),
    bottomShape: z.discriminatedUnion(
      "shape",
      [circularCrossSection, rectangularCrossSection, sphericalSegment]
    )
  }).nullable().optional()
})
